...
for j=3:length(folders)
    ...
    subplot(1,3,1), imshow('MAX_C3_grey.tif')
    title('Original')
    subplot(1,3,2), imshow('Flat of MAX_C3_grey_Thresh.tif')
    title('Thresholded')
    subplot(1,3,3), imshow('Mask of MAX_C3_grey.tif')
    title('Analysed')
